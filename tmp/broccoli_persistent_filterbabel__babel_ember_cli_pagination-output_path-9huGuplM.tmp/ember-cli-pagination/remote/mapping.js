define('ember-cli-pagination/remote/mapping', ['exports', 'ember-cli-pagination/validate', 'ember-cli-pagination/util'], function (exports, _validate, _util) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.ChangeMeta = exports.QueryParamsForBackend = undefined;
  var QueryParamsForBackend = exports.QueryParamsForBackend = Ember.Object.extend({
  ...
  var ChangeMeta = exports.ChangeMeta = Ember.Object.extend({
    ...
    validate: function validate(meta) {
      if (_util.default.isBlank(meta.total_pages)) {
        _validate.default.internalError("no total_pages in meta response", meta);
      }
    }
  });
});